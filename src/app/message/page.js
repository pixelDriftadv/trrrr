...
export default function Home() {
  return (
   ...
   <h1 className="text-xs font-light">
    ...
    aur agr nahi ho toh mereko chorhke matt jaana, saali harami randi mera dimag ka nuts dhila kardi abb kisi chiz mein mann nahi lagta, ek din bass samne dikh jaaye apna life mein gaali sikha hi hu sirf usko dene ke liye uska muh ke samne saara haar ek gaali dunga harami chutiya randi <br/>
